...
class PostApi {
   ...
   */
  getById(postId) {
    const url = `https://js-post-api.herokuapp.com/api/products?categoryId=${postId}&_page=1&_limit=12&fbclid=IwAR0Yv86gf6iDJvv900jGve2Df7EAlQU_QNKkrk9tN76x0s3UNjKv9cfrl3c`;
